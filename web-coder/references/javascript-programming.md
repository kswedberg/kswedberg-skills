...
description: JavaScript and ECMAScript syntax, semantics, modules, async patterns, and modern programming practices for the web.
metadata:
  tags: javascript, ecmascript, es-modules, async, promises, typescript-adjacent, patterns
---
