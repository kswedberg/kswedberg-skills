...
description: HTTP and HTTPS, request/response semantics, caching, cookies, and core networking concepts for the web.
metadata:
  tags: http, https, networking, fetch, cookies, caching, tls, rest
---
