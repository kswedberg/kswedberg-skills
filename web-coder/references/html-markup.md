---
name: html-markup
description: HTML5, semantic markup, document structure, forms, and metadata for web pages and applications.
metadata:
  tags: html, markup, semantic-html, forms, metadata, accessibility-markup
---
