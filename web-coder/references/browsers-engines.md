---
name: browsers-engines
description: Web browsers, rendering engines (Blink, Gecko, WebKit), JavaScript engines, and browser-specific behavior.
metadata:
  tags: browsers, blink, gecko, webkit, v8, spidermonkey, devtools, compatibility
---
