...
description: Web security fundamentals, authentication, authorization, HTTPS, headers, and secure coding on the web.
metadata:
  tags: security, authentication, authorization, cors, csp, https, owasp, cookies, jwt
---
